...
<body>
	<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
		  ...
		  <tr>
		    <td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce" onmouseover="changeto()"  onmouseout="changeback()">
		      ...
		      <c:if test="${deploymentList!=null and deploymentList.size()>0}">
		      	<c:forEach items="${deploymentList}" var="dep">
		      		<tr>
				        ...
				        <td height="20" bgcolor="#FFFFFF"><div align="center" class="STYLE21">
				        	<a href="${pageContext.request.contextPath }/workflow/delDeployment?deploymentId=${dep.id}">删除</a>
				        </div></td>
				    </tr> 
				  </c:forEach>
		      </c:if>
		...
		<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
		  ...
		  <tr>
		    <td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce" onmouseover="changeto()"  onmouseout="changeback()">
		      ...
		      <c:if test="${processDefinitionList!=null and processDefinitionList.size()>0}">
		      	<c:forEach items="${processDefinitionList}" var="pd">
		      		<tr>
				        ...
				        <td height="20" bgcolor="#FFFFFF"><div align="center" class="STYLE21">
				        	<a target="_blank" href="${pageContext.request.contextPath }/workflow/viewImage?deploymentId=${pd.deploymentId}&imageName=${pd.diagramResourceName}">查看流程图</a> 
					 	</div></td>
				    </tr> 
		      	</c:forEach>
		      </c:if>
	...
	<br/>
	<!-- 发布流程 -->
	<form action="${pageContext.request.contextPath}/workflow/newdeploy" enctype="multipart/form-data" method="POST">
		<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
		  <tr>
		    <td height="30"><table width="100%" border="0" cellspacing="0" cellpadding="0">
		      <tr>
