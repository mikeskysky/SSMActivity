		    ...
		    <td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce" onmouseover="changeto()"  onmouseout="changeback()">
		      ...
		      <c:if test="${taskList!=null}">
		      	<c:forEach items="${taskList}" var="task">
		      		<tr>
				        <td height="20" bgcolor="#FFFFFF" class="STYLE6">${task.id}</div></td>
				        <td height="20" bgcolor="#FFFFFF" class="STYLE19">${task.name}</div></td>
				        ...
				        <td height="20" bgcolor="#FFFFFF"><div align="center" class="STYLE21">
				        	<a href="${pageContext.request.contextPath }/workflow/viewTaskForm?taskId=${task.id}">办理任务</a>
							<a target="_blank" href="${pageContext.request.contextPath }/workflow/viewCurrentImage?taskId=${task.id}">查看当前流程图</a>
				        </div></td>
				    </tr> 
		      	</c:forEach>
		      </c:if>
